...
//                editor1.commit();
//
//                SharedPreferences sharedpreferences1 = getSharedPreferences(Constants.enable_pattern_lock, Context.MODE_PRIVATE);
//                SharedPreferences.Editor editor2 = sharedpreferences1.edit();
//                editor2.putString(Constants.enable_pattern_lock_status, "disable");
//                editor2.commit();

                stopService(new Intent(this , LockScreenService.class));

                Intent MainIntent = new Intent(this , MainActivityPin.class);
...
//                editor2.commit();
                ...
                Intent MainIntent = new Intent(this , MainActivityPattern.class);
                MainIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(MainIntent);
                stopSelf();
